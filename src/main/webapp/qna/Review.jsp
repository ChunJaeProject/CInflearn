...
<body>
    <div id="container">
        ...
        <div id="contents_top_area" class="cal_h100">
            <br><span style="font-size: large; font-weight: bold;">수강평</span><span>(개수)</span>
        </div>
        <section id="section">
            <div id="sidebar_left">
                <ul id="sidebar_ul">
            ...
            <div id="content">
                <div class="review">
                    <div id="box1">
                        ...
                        <p id="bottom">작성자 : 작성자 ID, 강의명 : 강의명</p>
                    </div>
                ...
                <div class="review">
                    ...
                    <div id="box2"><input type="image" id="btn_go" name="btn_go" src="../assets/image/HTML-CSS--IFL.png" width="300px" height="200px"></div>
                </div>
