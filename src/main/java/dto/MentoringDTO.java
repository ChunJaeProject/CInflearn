...
public class MentoringDTO {
	...
	/**
	 * @return the mentoring_intro
	 */
	public String getMentoring_intro() {
		return mentoring_intro;
	}
	/**
	 * @param mentoring_intro the mentoring_intro to set
	 */
	public void setMentoring_intro(String mentoring_intro) {
		this.mentoring_intro = mentoring_intro;
	}
	/**
	 * @return the job_code
	 */
